...
const cards = [
...

  {
    ...
    type: "Skillset",
    passives:
      "<strong>Nimble: </strong>Increase the applied characters default dodge chance by 5%.<br><strong>Slightly faster:</strong> +2 DEX<br><strong>Skipped arm days for leg days: </strong>The applied card will deal 20 less melee damage.",
    active: `
